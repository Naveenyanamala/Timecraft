...
import 'package:timecraft/settings/color_icon.dart';
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        showAboutDialog(
                          ...
                          applicationLegalese: '©2023 TimeCraft',
                          children: <Widget>[
                            Padding(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () async {
                                          final Uri url = Uri.parse(
                                              'https://TimeCraft.space/terms.html#privacy');
                                          if (await canLaunchUrl(url)) {
                                            await launchUrl(
                                              url,
                                              mode: LaunchMode
                                    ...
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () async {
                                          final Uri url = Uri.parse(
                                              'https://TimeCraft.space/terms.html#disclaimer');
                                          if (await canLaunchUrl(url)) {
                                            await launchUrl(
                                              url,
                                              mode: LaunchMode
