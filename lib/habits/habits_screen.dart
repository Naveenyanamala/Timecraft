...
class _HabitsScreenState extends State<HabitsScreen> {
  ...
  void showRestoreDialog(BuildContext context) {
    AwesomeDialog(
      ...
      title: "Notifications",
      desc:
          "TimeCraft needs permission to send notifications to work properly.",
      btnOkText: "Allow",
